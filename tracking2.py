...
while True:
    ...
    lower_red1 = np.array([167, 118, 20])
    ...
    for contours in cnt_green:
        # Calculate area
        area = cv2.contourArea(contours)

        # Distinguish small and big contours
        if 2500 < area < 45000:
    ...
    # Observing the results which size was adjust
